...
//  AlbumArt
//
//  Created by Whitney Lauren on 5/29/15.
...
class AlbumCollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
       ...
       // self.collectionView!.registerClass(UICollectionViewCell.self, forCellWithReuseIdentifier:
          //  reuseIdentifier)
        
        var requestManager = AFHTTPRequestOperationManager()
        
        requestManager.GET(itunesAPI + "?entity=album&term=DaftPunk", parameters: nil, success: {
