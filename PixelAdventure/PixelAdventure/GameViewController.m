...
- (IBAction)moveButtonPressed:(UIButton *)sender {
    ...
    NSArray * directions = @[
                             [NSValue valueWithCGVector:CGVectorMake(0.0,30.0)], //up
                             [NSValue valueWithCGVector:CGVectorMake(-10.0,-0.0)],//left
                             [NSValue valueWithCGVector:CGVectorMake(0.0,-10.0)],//down
                             [NSValue valueWithCGVector:CGVectorMake(10.0,0.0)],//right
